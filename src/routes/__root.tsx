  ...
  head: () => ({
    meta: [
      ...
      { title: "AI Chat" },
      {
        name: "description",
        content:
          "Prompt Optimizer — rövid, pontos, bármelyik AI modellhez illő promptok készítése és finomítása.",
      },
      { name: "author", content: "Prompt Optimizer" },
      { property: "og:title", content: "Prompt Optimizer" },
      {
